 ...
 * 
 */
@WebServiceClient(name = "CursoServicioWsImplService", targetNamespace = "http://services.jaxws.webapp.eitorresmendoza.org/", wsdlLocation = "http://localhost:8080/webapp-jaxws-jpa-jaas/CursoServicioWsImpl?wsdl")
    ...
    extends Service
{
    ...
    private static final QName CURSOSERVICIOWSIMPLSERVICE_QNAME = new QName("http://services.jaxws.webapp.eitorresmendoza.org/", "CursoServicioWsImplService");
    ...
    public CursoServicioWs getCursoServicioWsImplPort() {
        return super.getPort(new QName("http://services.jaxws.webapp.eitorresmendoza.org/", "CursoServicioWsImplPort"), CursoServicioWs.class);
    }
    ...
    public CursoServicioWs getCursoServicioWsImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.jaxws.webapp.eitorresmendoza.org/", "CursoServicioWsImplPort"), CursoServicioWs.class, features);
    }
