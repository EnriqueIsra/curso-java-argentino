...
//        env.put("jboss.naming.client.ejb.context", true);
        try {
            ...
            service = (ServiceEjbRemote) ctx.lookup("ejb:/appejb-remote/ServiceEjb!org.eitorresmendoza.webapp.ejb.services.ServiceEjbRemote?stateful");
            service2 = (ServiceEjbRemote) ctx.lookup("ejb:/appejb-remote/ServiceEjb!org.eitorresmendoza.webapp.ejb.services.ServiceEjbRemote?stateful");
