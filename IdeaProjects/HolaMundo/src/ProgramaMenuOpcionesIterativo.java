    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            Object opcion = JOptionPane.showInputDialog(
                    ...
                    "Mantenedor de usuario", JOptionPane.INFORMATION_MESSAGE,
            ...
            if(opcion == null) {
                ...
                opcionesIndice = opciones.get(opcion.toString());
                String mensaje = null;
                switch (opcionesIndice){
                    case 1 -> {
